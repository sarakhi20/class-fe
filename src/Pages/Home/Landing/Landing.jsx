    ...
    {/* Top Section */}
      ...
      <div className="about" style={{backgroundColor: "#042439"}}>
        ...
        <div className="content">
          ...
          <p>
            At Education Counseling, we believe in the power of education to transform lives. Our platform is designed to be a gateway to knowledge, offering a diverse range of courses and learning experiences for students.
            <h1 className=" bg-blue-700 w-fit py-1 px-3 rounded-sm my-2">Our Story</h1>
            Saro was born out of a passion for learning and a desire to make quality education accessible to everyone. We understand the challenges faced by modern learners and strive to provide a solution that is both convenient and effective.
